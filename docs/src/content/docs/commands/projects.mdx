...
| `--parent`             | New parent project ID (0 detaches) |
| `--inherit-members`    | Toggle inheriting members from the parent project |
| `--default-assignee`   | Default assignee (login, name, ID; empty clears) |
| `--default-version`    | Default version (name or numeric ID; empty clears) |
