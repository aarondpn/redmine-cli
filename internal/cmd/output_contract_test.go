...
var commandOutputContracts = map[string]commandContract{
	...
	"redmine issues relations add":    {Mode: outputContractStructured},
	"redmine issues relations list":   {Mode: outputContractStructured},
	"redmine issues relations remove": {Mode: outputContractStructured},
	"redmine issues reopen":           {Mode: outputContractStructured},
	"redmine issues update":           {Mode: outputContractStructured},
	"redmine issues watchers add":     {Mode: outputContractStructured},
	"redmine issues watchers list":    {Mode: outputContractStructured},
	"redmine issues watchers remove":  {Mode: outputContractStructured},
	...
	"redmine projects unarchive":      {Mode: outputContractStructured},
	...
	"redmine versions create":         {Mode: outputContractStructured},
	"redmine versions update":         {Mode: outputContractStructured},
	"redmine versions delete":         {Mode: outputContractStructured},
